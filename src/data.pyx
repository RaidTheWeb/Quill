...
cdef class Method(Type):
    ...
    cpdef String string(self):
        return String(f'<Method {id(self.val)}>')

cdef class String(Type):
...
cdef class Number(Type):
    ...
    cpdef Number add(self, other):
        return Number(self.val + other.val)


cdef class Symbol(Type):
    def __init__(self, val):
